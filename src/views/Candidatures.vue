      ...
      <div v-else-if="selectedCandidat" class="space-y-3 text-sm">
        ...
        <div class="flex flex-col gap-1">
          ...
          <div class="flex flex-wrap gap-1">
            <UBadge
              v-for="c in selectedCandidat.competences"
              :key="c"
              :label="c"
              variant="subtle"
            />
        ...
        <div class="flex flex-col gap-2">
          ...
          <div v-if="selectedCandidat.commentaires.length === 0" class="text-sm text-muted">
            Aucun commentaire
          </div>
          <div v-else class="space-y-2">
            <div
              v-for="com in selectedCandidat.commentaires"
              :key="com.id"
